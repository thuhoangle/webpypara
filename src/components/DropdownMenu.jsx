...
import { Tooltip, Link, Flex } from '@chakra-ui/react';
    ...
    <div className="absolute right-4">
      <div className="flex justify-end pt-3">
        <HoverCard.Root openDelay={300} closeDelay={100}>
          <HoverCard.Trigger
            className={'mx-1 p-3 rounded-full bg-zinc-200 cursor-pointer'}
          >
          ...
          <HoverCard.Portal>
            <HoverCard.Content>
              <Flex
                direction={{ base: 'horizontal', md: 'column' }}
                gap={3}
                cursor={'pointer'}
                className={'mt-2 bg-zinc-200 w-fit items-center rounded-full'}
              >
                ...
                >
                  <div
                    className={
                      'rounded-full p-2 hover:bg-slate-50 items-center'
                    }
                  >
                    <SearchProfile />
                  </div>
                ...
                >
                  ...
                  <div
                    ...
                    className={
                      'cursor-pointer items-center rounded-full p-2 hover:bg-slate-50'
                    }
                  >
                    <MdLogout className="w-7 h-7 text-red-500" />
                  </div>

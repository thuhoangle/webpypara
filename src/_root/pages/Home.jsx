...
const Home = () => {
  let Links = [{ name: 'User', link: './' }];
  return (
    <div>
      <HeaderHome />
      <div className={'py-20 justify-center items-center flex flex-row gap-2'}>
        <RiFocus2Line />
        <p className={'font-bold font-mono text-[35px] text-black'}>
          {' '}
          A website for Website Application Development course.
        </p>
      </div>
      <div
        className={
          'w-3/4 float-right flex flex-col items-start  text-[35px] mt-[20px] text-left'
        }
      >
        <img src={line} />
        ...
        <div className={'flex flex-row gap-20'}>
          <a
            href={'https://github.com/thuhoangle/webpypara'}
            target={'_blank'}
            className={'mt-[20px] bg-white rounded-full border border-black'}
          >
            <div
              className={
                'px-4 py-2 font-mono font-thin text-[20px] text-black text-center'
              }
            >
              GITHUB↗
            </div>
          ...
          <a
            href={
              'https://www.canva.com/design/DAGIuOLFioc/zy5KKqpnvIVKlY8QYb0rFw/edit?utm_content=DAGIuOLFioc&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton'
            }
            target={'_blank'}
            className={'mt-[20px] bg-white rounded-full border border-black'}
          >
